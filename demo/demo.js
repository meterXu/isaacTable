...
$(function () {
    $.getJSON("data.json", function (res) {
        ...
        icon_option.data=res.icon;
        $("#attribute").isaacTable(attribute_option);
        attribute_option.data = res.colAttribute;
        $("#colAttribute").isaacTable(attribute_option);
        $("#method").isaacTable(method_option);
        $("#event").isaacTable(event_option);
        $("#icon").isaacTable(icon_option);
